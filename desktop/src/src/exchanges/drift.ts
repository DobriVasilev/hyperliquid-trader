...
// QuickNode RPC endpoints (31 day free trial, 10M credits)
const SOLANA_RPC_URL = "https://tame-chaotic-snow.solana-mainnet.quiknode.pro/d7c965f156d3257c83876b320e8ee029dda0e608/";
const SOLANA_WS_URL = "wss://tame-chaotic-snow.solana-mainnet.quiknode.pro/d7c965f156d3257c83876b320e8ee029dda0e608/";
...
export class DriftExchange implements Exchange {
  ...
  async initialize(credentials: ExchangeCredentials): Promise<void> {
    ...
    try {
      ...
      // Create Solana connection with QuickNode
      ...
      // Create DriftClient with WebSocket subscription (QuickNode)
      ...
      // Using QuickNode WebSocket
      console.log("[Drift] Starting QuickNode WebSocket subscription...");
      this.driftClient.subscribe()
        .then(() => {
          console.log("[Drift] WebSocket subscription active");
        })
        .catch((err) => {
