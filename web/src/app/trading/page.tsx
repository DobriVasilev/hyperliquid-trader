      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex justify-end mb-4">
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-gray-600 rounded-lg text-sm text-gray-300 hover:text-white transition-colors"
          >
