        ...
        >
          <div className="flex items-center">
            <Link href="/" className="flex items-center gap-2">
              <svg className="w-8 h-10" viewBox="0 0 28 35" fill="none">
                <path d="M14 0L28 8.75V26.25L14 35L0 26.25V8.75L14 0Z" fill="url(#logo-gradient-hero)" />
                <path d="M14 7L21 11.375V20.125L14 24.5L7 20.125V11.375L14 7Z" fill="#000" fillOpacity="0.5" />
                <defs>
                  <linearGradient id="logo-gradient-hero" x1="0" y1="0" x2="28" y2="35" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#3B82F6" />
                    <stop offset="1" stopColor="#60A5FA" />
                  </linearGradient>
                </defs>
              </svg>
              <span className="text-xl font-semibold hidden sm:block">Systems Trader</span>
            </Link>
